...
let animationData6
new loadAnimation('shot52/sh52nailcutter.json').then(result => {
    ...
    return (
        <div className='aniObject'>
            ...
            <div
                style={{
                    position: "fixed",
                    width: _baseGeo.width * 0.7 + "px",
                    left: _baseGeo.left + _baseGeo.width * 0.15 + "px",
                    bottom: _baseGeo.height * 0.22 + _baseGeo.bottom + "px",
                }}
            >
            ...
            <div className='subText'
                style={{
                    ...
                    right: _baseGeo.left + _baseGeo.width * 0.25 + "px",
                    bottom: '5%',
                }}
            >
                <img draggable = {false} src={prePathUrl() + 'images/icons/sb_14_ti_keep_your_nails_clean_and_short.svg'}
                    width={'100%'} />
            </div>
        </div>
    );
